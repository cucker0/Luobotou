...
class ThirdPartyServiceManagement(BasicModel):
    ...
    name = models.CharField(max_length=64, unique=True, verbose_name="平台/服务名")
    management_info = models.CharField(max_length=512, null=True, blank=True, verbose_name="关联User 表用户的ID(json)")
