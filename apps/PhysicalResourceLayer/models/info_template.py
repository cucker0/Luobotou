...
class MemoryInfoTemplate(BasicModel):
    ...
    内存信息模板
    """
    id = models.CharField(max_length=36, default=generate_id.memory_info_template, primary_key=True, unique=True)
    model = models.CharField(max_length=64, unique=True, verbose_name="型号")
    brand = models.CharField(max_length=32, verbose_name="品牌")
...
class DiskInfoTemplate(BasicModel):
    ...
    硬盘信息模样
    """
    id = models.CharField(max_length=36, default=generate_id.disk_info_template, primary_key=True, unique=True)
    lable = models.CharField(max_length=64, verbose_name="标识")
    model = models.CharField(max_length=64, unique=True, verbose_name="型号")
    brand = models.CharField(max_length=32, verbose_name="品牌")
    type = models.CharField(max_length=32, verbose_name="介质类型(Media Type)")
    capacity = models.IntegerField(verbose_name="容量(int)，单位:GB")
    form_factor = models.CharField(max_length=32, verbose_name="规格")
    interface = models.CharField(max_length=32, verbose_name="接口类型")
