...
class PhysicalMachine(BasicModel):
    ...
    raid_info = models.CharField(max_length=5120, verbose_name="阵列信息(json)")
    nic_info = models.CharField(max_length=1024, verbose_name="网卡信息(json)")
    cabinet = models.ForeignKey(Cabinet, on_delete=models.PROTECT, verbose_name="")
    ...
    warranty_info = models.CharField(max_length=512, verbose_name="保修信息(json)")
